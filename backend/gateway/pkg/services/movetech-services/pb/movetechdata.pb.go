...
var file_pkg_pb_movetechdata_proto_rawDesc = []byte{
	...
	0x49, 0x47, 0x48, 0x10, 0x05, 0x32, 0xcc, 0x02, 0x0a, 0x19, 0x4d, 0x6f, 0x76, 0x65, 0x54, 0x65,
...
var file_pkg_pb_movetechdata_proto_depIdxs = []int32{
	...
	2,  // 4: api.MoveTechAdminProtoService.SaveProduct:input_type -> api.SaveProductRequest
	5,  // 5: api.MoveTechAdminProtoService.SaveFreebies:input_type -> api.SaveFreebiesRequest
	7,  // 6: api.MoveTechAdminProtoService.GetAllFreebies:input_type -> api.GetAllFreebiesRequest
	9,  // 7: api.MoveTechAdminProtoService.GetAllFreebiesById:input_type -> api.GetAllFreebiesRequestById
	3,  // 8: api.MoveTechAdminProtoService.SaveProduct:output_type -> api.SaveProductResponse
	6,  // 9: api.MoveTechAdminProtoService.SaveFreebies:output_type -> api.SaveFreebiesResponse
	8,  // 10: api.MoveTechAdminProtoService.GetAllFreebies:output_type -> api.GetAllFreebiesResponse
	10, // 11: api.MoveTechAdminProtoService.GetAllFreebiesById:output_type -> api.GetAllFreebiesResponseById
