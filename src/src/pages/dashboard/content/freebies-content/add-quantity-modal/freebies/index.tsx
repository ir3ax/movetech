...
export const FreebiesModalUpdateQuantity = (props: Freebie) => {
  
  const freebiesFormQuantity = useFormContext<UpdateQuantityFreebiesRequest>()
    ...
    <div className='w-full pb-8'> 
      ...
      <div className='mt-6 w-full flex gap-6'>
        ...
        <div className='w-[100%] flex flex-col gap-2'>
            ...
            <FormField
                control={freebiesFormQuantity.control}
