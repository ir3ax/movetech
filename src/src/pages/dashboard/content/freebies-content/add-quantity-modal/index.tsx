...
import { FreebiesModalUpdateQuantity } from './freebies';
...
export const ModalViewUpdateQuantity = (props: Xprox) => {
  ...
  const freebiesFormUpdateQuantity = useForm<UpdateQuantityFreebiesRequest>({
    defaultValues: {
        freebiesId: freebiesId,
        freebiesOriginalQuantity: props.freebiesOriginalQuantity,
        freebiesCurrentQuantity: props.freebiesCurrentQuantity
    },
    mode: 'onChange',
            ...
            <Form {...freebiesFormUpdateQuantity}>
              ...
              <Stepper
                    ...
                    <div className='stepperSubDiv'>
                        <FreebiesModalUpdateQuantity freebiesId={props.freebiesId} freebiesOriginalQuantity={props.freebiesOriginalQuantity} freebiesCurrentQuantity={props.freebiesCurrentQuantity} />
                    </div>
                    </Stepper>
              </form>
            </Form>
